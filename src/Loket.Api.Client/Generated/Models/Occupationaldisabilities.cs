...
namespace Loket.Api.Client.Models
{
    ...
    public partial class Occupationaldisabilities : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Loket.Api.Client.Models.Occupationaldisabilities"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Loket.Api.Client.Models.Occupationaldisabilities CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.Models.Occupationaldisabilities();
        }
        /// <summary>

...
namespace Loket.Api.Client.Models
{
    ...
    public partial class LeavePolicy_leaveRequest_leavePattern_oddWeeks : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Loket.Api.Client.Models.LeavePolicy_leaveRequest_leavePattern_oddWeeks"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Loket.Api.Client.Models.LeavePolicy_leaveRequest_leavePattern_oddWeeks CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.Models.LeavePolicy_leaveRequest_leavePattern_oddWeeks();
        }
        /// <summary>

...
namespace Loket.Api.Client.Models
{
    ...
    public partial class SchemasWorkingHours_workPattern_oddWeeks : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Loket.Api.Client.Models.SchemasWorkingHours_workPattern_oddWeeks"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Loket.Api.Client.Models.SchemasWorkingHours_workPattern_oddWeeks CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.Models.SchemasWorkingHours_workPattern_oddWeeks();
        }
        /// <summary>

...
namespace Loket.Api.Client.Models
{
    ...
    public partial class Initiatecontractextension : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Loket.Api.Client.Models.Initiatecontractextension"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Loket.Api.Client.Models.Initiatecontractextension CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.Models.Initiatecontractextension();
        }
        /// <summary>

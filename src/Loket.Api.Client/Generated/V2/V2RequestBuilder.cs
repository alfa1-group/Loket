...
using Loket.Api.Client.V2.Providers;
...
namespace Loket.Api.Client.V2
{
    ...
    public partial class V2RequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Loket.Api.Client.V2.Providers.ProvidersRequestBuilder Providers
        {
            get => new global::Loket.Api.Client.V2.Providers.ProvidersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Loket.Api.Client.V2.V2RequestBuilder"/> and sets the default values.
        /// </summary>

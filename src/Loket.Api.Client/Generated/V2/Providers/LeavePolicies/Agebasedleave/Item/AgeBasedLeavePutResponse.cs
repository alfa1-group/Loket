...
namespace Loket.Api.Client.V2.Providers.LeavePolicies.Agebasedleave.Item
{
    ...
    public partial class AgeBasedLeavePutResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.LeavePolicies.Agebasedleave.Item.AgeBasedLeavePutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.LeavePolicies.Agebasedleave.Item.AgeBasedLeavePutResponse();
        }
        /// <summary>

...
namespace Loket.Api.Client.V2.Providers.LeavePolicies.Item.Yearsofservicebasedleave
{
    ...
    public partial class YearsofservicebasedleavePostResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.LeavePolicies.Item.Yearsofservicebasedleave.YearsofservicebasedleavePostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.LeavePolicies.Item.Yearsofservicebasedleave.YearsofservicebasedleavePostResponse();
        }
        /// <summary>

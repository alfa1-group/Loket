...
namespace Loket.Api.Client.V2.Providers.Item.Notificationsets
{
    ...
    public partial class NotificationsetsGetResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.Item.Notificationsets.NotificationsetsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.Item.Notificationsets.NotificationsetsGetResponse();
        }
        /// <summary>

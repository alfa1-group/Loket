...
namespace Loket.Api.Client.V2.Providers.Employers.LeavePolicies.Item.Employments.Leave.Entitlement
{
    ...
    public partial class EntitlementRequestBuilder : BaseRequestBuilder
    {
        ...
        public EntitlementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavepolicies/{leavePolicyId}/employments/leave/entitlement{?filter*,month*,orderBy*,overridingEmploymentEndDate*,pageNumber*,pageSize*,year*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Loket.Api.Client.V2.Providers.Employers.LeavePolicies.Item.Employments.Leave.Entitlement.EntitlementRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EntitlementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavepolicies/{leavePolicyId}/employments/leave/entitlement{?filter*,month*,orderBy*,overridingEmploymentEndDate*,pageNumber*,pageSize*,year*}", rawUrl)
        {
        }
        /// <summary>

...
namespace Loket.Api.Client.V2.Providers.Employers.Leavepolicies.Item.Wagebasedleave
{
    ...
    public partial class WagebasedleaveRequestBuilder : BaseRequestBuilder
    {
        ...
        public WagebasedleaveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavePolicies/{leavePolicyId}/wagebasedleave{?filter*,orderBy*,pageNumber*,pageSize*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Loket.Api.Client.V2.Providers.Employers.Leavepolicies.Item.Wagebasedleave.WagebasedleaveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WagebasedleaveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavePolicies/{leavePolicyId}/wagebasedleave{?filter*,orderBy*,pageNumber*,pageSize*}", rawUrl)
        {
        }
        /// <summary>

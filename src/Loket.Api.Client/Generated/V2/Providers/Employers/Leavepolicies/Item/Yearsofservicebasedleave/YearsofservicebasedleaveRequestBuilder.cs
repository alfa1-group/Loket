...
namespace Loket.Api.Client.V2.Providers.Employers.Leavepolicies.Item.Yearsofservicebasedleave
{
    ...
    public partial class YearsofservicebasedleaveRequestBuilder : BaseRequestBuilder
    {
        ...
        public YearsofservicebasedleaveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavePolicies/{leavePolicyId}/yearsofservicebasedleave{?filter*,orderBy*,pageNumber*,pageSize*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Loket.Api.Client.V2.Providers.Employers.Leavepolicies.Item.Yearsofservicebasedleave.YearsofservicebasedleaveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public YearsofservicebasedleaveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/providers/employers/leavePolicies/{leavePolicyId}/yearsofservicebasedleave{?filter*,orderBy*,pageNumber*,pageSize*}", rawUrl)
        {
        }
        /// <summary>

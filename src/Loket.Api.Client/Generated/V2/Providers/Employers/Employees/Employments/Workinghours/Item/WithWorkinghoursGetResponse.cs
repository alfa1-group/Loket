...
namespace Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item
{
    ...
    public partial class WithWorkinghoursGetResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item.WithWorkinghoursGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item.WithWorkinghoursGetResponse();
        }
        /// <summary>

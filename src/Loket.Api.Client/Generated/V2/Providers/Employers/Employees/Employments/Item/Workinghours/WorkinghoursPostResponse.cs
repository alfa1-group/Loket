...
namespace Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Item.Workinghours
{
    ...
    public partial class WorkinghoursPostResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Item.Workinghours.WorkinghoursPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Item.Workinghours.WorkinghoursPostResponse();
        }
        /// <summary>

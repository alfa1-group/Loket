...
namespace Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item
{
    ...
    public partial class WithWorkinghoursPutResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item.WithWorkinghoursPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.Employers.Employees.Employments.Workinghours.Item.WithWorkinghoursPutResponse();
        }
        /// <summary>

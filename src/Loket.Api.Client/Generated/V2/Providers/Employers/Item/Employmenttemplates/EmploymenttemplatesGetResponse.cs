...
namespace Loket.Api.Client.V2.Providers.Employers.Item.Employmenttemplates
{
    ...
    public partial class EmploymenttemplatesGetResponse : IParsable
...
#nullable restore
        ...
        public static global::Loket.Api.Client.V2.Providers.Employers.Item.Employmenttemplates.EmploymenttemplatesGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Loket.Api.Client.V2.Providers.Employers.Item.Employmenttemplates.EmploymenttemplatesGetResponse();
        }
        /// <summary>
